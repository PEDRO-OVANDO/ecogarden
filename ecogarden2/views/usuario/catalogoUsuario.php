...
<head>
    ...
    <link rel="stylesheet" href="../css/responsiveCatalogoU.css">
</head>
<body>
    <!--header -->
    <header class="header">
        <div class="container">
            <nav class="nav">
                ...
                <div class="nav-links">
                    <a href="catalogoUsuario.php" class="nav-link" style="color: var(--primary-color);">Productos</a>
        ...
        <section class="productos-scroll">
            ...
            <?php if (empty($productos)): ?>
                <div class="no-products">
                    ...
                    <a href="catalogoUsuario.php" class="btn btn-primary">Ver Todos los Productos</a>
                </div>
            <?php else: ?>
                        ...
                        <div class="producto-info">
                            ...
                            <div class="producto-acciones">
                                <?php if ($producto['stock'] > 0): ?>
                                    <a href="carritoUsuario.php?agregar=<?php echo $producto['id']; ?>" class="btn btn-primary btn-sm">
                                        Agregar al Carrito
                                    </a>
                                <?php else: ?>
